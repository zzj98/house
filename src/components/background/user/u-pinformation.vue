<template>
  <div class="pinformation">
    ...
    <h3>修改密码</h3><hr/>
    <el-card>
      <el-input type="password" class="passwordinput" v-model="password" auto-complete="off" placeholder="新密码"></el-input><br/>
      <el-input type="password" class="passwordinput" v-model="repassword" auto-complete="off" placeholder="再次核对"></el-input><br/>
